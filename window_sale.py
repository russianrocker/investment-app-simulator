...
def gazprom():
    ...
    gazprom_sale.title('Gazprom: Покупка акций')
...
def avtovaz():
    ...
    avtovaz_sale.title('Avtovaz: Покупка акций')
...
def aeroflot():
    ...
    aeroflot_sale.title('Gazprom: Покупка акций')
...
def nornickel():
    ...
    nornickel_sale.title('Nornickel: Покупка акций')
